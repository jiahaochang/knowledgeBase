...
interface ResearchLearningTableProps extends React.Props<ResearchLearningTable> {

}

interface ResearchLearningTableState {
    data?:Array<any>,
    pagination?:any,
    loading?:boolean,
 ...
 * 课程库---研究性学习table
 */
class ResearchLearningTable extends React.Component<ResearchLearningTableProps, ResearchLearningTableState> {
    constructor(props) {
        super(props);
        this.state = {
            data:[],
