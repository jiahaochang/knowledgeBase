...
interface SchoolActivitiesLibTableProps extends React.Props<SchoolActivitiesLibTable> {

}

interface SchoolActivitiesLibTableState {
    data?:Array<any>,
    pagination?:any,
    loading?:boolean,
 ...
 * 活动与社团库---校内活动库table
 */
class SchoolActivitiesLibTable extends React.Component<SchoolActivitiesLibTableProps, SchoolActivitiesLibTableState> {
    constructor(props) {
        super(props);
        this.state = {
            data:[],
...
export = SchoolActivitiesLibTable