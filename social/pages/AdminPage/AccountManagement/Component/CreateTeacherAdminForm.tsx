...
interface CreateTeacherAdminFormProps extends React.Props<CreateTeacherAdminForm> {
    form?:any,
...
interface CreateTeacherAdminFormState {
 ...
 */
class CreateTeacherAdminForm extends React.Component<CreateTeacherAdminFormProps, CreateTeacherAdminFormState>{
    constructor(props) {
        super(props);
...
export = createForm()(CreateTeacherAdminForm)