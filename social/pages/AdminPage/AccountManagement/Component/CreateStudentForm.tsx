...
interface CreateStudentFormProps extends React.Props<CreateStudentForm> {
    form?:any,
 ...
 * 编辑学生信息 or  添加学生信息
 */
class CreateStudentForm extends React.Component<CreateStudentFormProps, CreateStudentFormState>{
    constructor(props) {
        super(props);
...
export = createForm()(CreateStudentForm)