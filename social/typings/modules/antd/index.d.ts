...
// Source: node_modules/antd/type-definitions/antd.d.ts
declare module 'antd' {
...
namespace Antd {
  ...
  */
  ...
  interface FormComponentProps {
    form?: CreateFormOptions  //2016/6/20 谭春燕  原因：Form组件读取this.props.form出错
  }
  ...
  */
  ...
  interface SelectOptionProps {
    ...
    /** 默认根据此属性值进行筛选*/
    value: string | number
      //2016-06-15 hp添加key value number选项
  ...
  interface SelectProps {
    //add by tcy 2016/7/21
    labelInValue?:boolean,
    /** 指定当前选中的条目*/
    value?: string | Array<any> | {key: String, label?: any},
    /** 指定默认选中的条目*/
