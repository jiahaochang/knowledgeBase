...
/***/ 836:
/*!**************************************************!*\
  !*** ./pages/AssessCenter/MIAssess/MIAssess.tsx ***!
  \**************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var MIAssessGuide = __webpack_require__(/*! ./MIAssessGuide */ 837);
	var MIAssessResult = __webpack_require__(/*! ./MIAssessResult */ 838);
	 ...
	 *  }
	 */
	var MIAssess = (function (_super) {
	    __extends(MIAssess, _super);
	    function MIAssess(props) {
	        _super.call(this, props);
	        this.state = {};
	    }
	    MIAssess.prototype.componentWillMount = function () {
	        //ajax
	        Actions.initMIAssessFinishState();
	    };
	    MIAssess.prototype.render = function () {
	        var isMIAssessFinished = context.getMIAssessFinishState();
	        var title = isMIAssessFinished === true ? "结果" : "";
	        return (React.createElement("div", {className: "am-margin-top"}, React.createElement("div", {className: "MIGuideTitle"}, React.createElement("img", {src: HomePageConfig_1.assessCenterDisplayMap.multipleIntelligence.imgUrl}), React.createElement("span", null, HomePageConfig_1.assessCenterDisplayMap.multipleIntelligence.name + "测试" + title)), isMIAssessFinished === true &&
	            React.createElement(MIAssessResult, null), isMIAssessFinished === false &&
	            React.createElement(MIAssessGuide, null)));
	    };
	    return MIAssess;
	}(React.Component));
	module.exports = MIAssess;
...
/***/ 837:
/*!*******************************************************!*\
  !*** ./pages/AssessCenter/MIAssess/MIAssessGuide.tsx ***!
  \*******************************************************/
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var MIAssessGuide = (function (_super) {
	    __extends(MIAssessGuide, _super);
	    function MIAssessGuide(props) {
	        _super.call(this, props);
	        this.state = {};
	        this.goToMIAssess = this.goToMIAssess.bind(this);
	    }
	    MIAssessGuide.prototype.goToMIAssess = function () {
	        var url = "assessCenter/MIAssess/MIQuizPage";
	        this.props.router.push(url);
	    };
	    MIAssessGuide.prototype.componentWillMount = function () {
	        //ajax获取介绍内容
	        var this_ = this;
	        ajaxUtil.getDataByActionID(ActionTypes.GET_MIASSESS_INTRODUCTION, function (response) {
	            var introduction = response.result.MIIntroduction;
	            this_.setState({
	                MIIntroduction: introduction.MIIntroduction,
	            });
	        });
	    };
	    MIAssessGuide.prototype.render = function () {
	        return (React.createElement("div", {className: "am-margin-top"}, React.createElement("div", {className: "am-text-center"}, React.createElement("img", {src: "vendor/images/tests/MIAssessGuide.png"})), React.createElement("div", {className: "career-intro-list"}, this.state.MIIntroduction, React.createElement("div", null, "预计时长：10分钟")), React.createElement("div", {className: "am-text-center"}, React.createElement(antd_1.Button, {className: "btn-blue", onClick: this.goToMIAssess, size: "large"}, "开始测试"))));
	    };
	    return MIAssessGuide;
	}(React.Component));
	module.exports = react_router_1.withRouter(MIAssessGuide);
...
/***/ 838:
/*!********************************************************!*\
  !*** ./pages/AssessCenter/MIAssess/MIAssessResult.tsx ***!
  \********************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var ajaxUtil = __webpack_require__(/*! ../../../common/ajaxUtil */ 385);
	var ActionTypes = __webpack_require__(/*! ../../../actions/AssessCenter/MIAssess/MIAssessActionTypes */ 394);
	var ResultIntroduction = __webpack_require__(/*! ./Component/ResultIntroduction */ 839);
	// 引入 ECharts 主模块
	...
	var MIAssessResult = (function (_super) {
	    __extends(MIAssessResult, _super);
	    function MIAssessResult(props) {
	        _super.call(this, props);
	        this.state = {
	            advantage: [],
	            disadvantage: [],
	    ...
	    MIAssessResult.prototype.componentDidMount = function () {
	        //ajax获取测试报告的结果
	        var this_ = this;
	    ...
	    MIAssessResult.prototype.getEcharts = function (data, dataValue) {
	    ...
	    MIAssessResult.prototype.render = function () {
	        var advantage = this.state.advantage;
	        var disadvantage = this.state.disadvantage;
	        return (React.createElement("div", null, React.createElement("div", {className: "blueBack block-box-shadows", style: { margin: "30px 15px", padding: "40px 20px 30px" }}, React.createElement("div", {className: "report-single-title holland-score-title"}, React.createElement("div", {className: "titleDIV"}, React.createElement("span", {className: "titleSpan"}, React.createElement("span", {className: "titleName"}, "你的八项多元智能分布图")))), React.createElement("div", {id: "echartsDom"}), React.createElement("div", {className: "MIAssess-score-tips"}, React.createElement("i", {className: "fa fa-bell-o"}), "得分说明：得分越高，说明您更擅长该方面或在该方面优势更为突出。")), React.createElement("div", {className: " block-box-shadows", style: { margin: "30px 15px", padding: "20px 20px 30px" }}, React.createElement("div", {className: "MIAssess-result-advantage-title"}, React.createElement("i", {className: "fa fa-user fa-2x am-padding-right-xs"}), "优势智能与解读"), React.createElement("div", {className: "am-margin-top"}, "你得分相对较高的三项智能是：", advantage &&
	            advantage.map(function (intro, index) {
	                var symbol = index != (advantage.length - 1) ? "，" : "。";
	                return (React.createElement("span", {key: index}, intro.resultDimName + symbol));
	            })), advantage &&
	            advantage.map(function (intro, index) {
	                return (React.createElement(ResultIntroduction, {key: index, colorName: "orange", dimType: intro.resultDimName, dimTypeIntroductions: intro.introductions}));
	            })), React.createElement("div", {className: "blueBack block-box-shadows", style: { margin: "30px 15px", padding: "20px 20px 30px" }}, React.createElement("div", {className: "MIAssess-result-advantage-title"}, React.createElement("i", {className: "fa fa-user fa-2x am-padding-right-xs"}), "劣势智能与提高方法"), React.createElement("div", {className: "am-margin-top"}, "你得分相对较低的两项智能是：", disadvantage &&
	            disadvantage.map(function (intro, index) {
	                var symbol = index != (disadvantage.length - 1) ? "，" : "。";
	                return (React.createElement("span", {key: index}, intro.resultDimName + symbol));
	            })), disadvantage &&
	            disadvantage.map(function (intro, index) {
	                return (React.createElement(ResultIntroduction, {key: index, colorName: "blue", dimType: intro.resultDimName, dimTypeIntroductions: intro.introductions}));
	            }))));
	    };
	    MIAssessResult.defaultProps = {};
	    return MIAssessResult;
	}(React.Component));
	module.exports = MIAssessResult;
...
/***/ 839:
/*!**********************************************************************!*\
  !*** ./pages/AssessCenter/MIAssess/Component/ResultIntroduction.tsx ***!
  \**********************************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var ResultIntroduction = (function (_super) {
	    ...
	    ResultIntroduction.prototype.render = function () {
	        ...
	        return (React.createElement("table", {className: "MIAssess-result-table am-margin-top " + this.props.colorName}, React.createElement("tr", null, React.createElement("td", {className: "title"}, dimType), React.createElement("td", {className: "content"}, introductions.map(function (intro, index) {
	            return (React.createElement("div", {key: index, className: "detail"}, React.createElement("span", {className: "detail-title"}, intro.introductionName), React.createElement("div", null, intro.introductionValue)));
	        })))));
	    };
