...
/***/ 777:
/*!**************************************************************************************!*\
  !*** ./pages/TermAnalysis/ComprehensiveQualityRecord/ComprehensiveQualityRecord.tsx ***!
  \**************************************************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var storageUtil_1 = __webpack_require__(/*! common/storageUtil */ 383);
	var commonVar_1 = __webpack_require__(/*! ../../../common/commonVar */ 355);
	var ComprehensiveQualityRecord = (function (_super) {
	    __extends(ComprehensiveQualityRecord, _super);
	    function ComprehensiveQualityRecord(props) {
	        _super.call(this, props);
	        this.state = {
	    ...
	    ComprehensiveQualityRecord.prototype.onTermChange = function (termAfterChange) {
	        this.setState({
	            currentTerm: termAfterChange
	        });
	    };
	    ComprehensiveQualityRecord.prototype.goToComprehensiveQualityReport = function () {
	        window.open(commonVar_1.comprehensiveURL + "/comprehensiveQualityReport.html?queryUserID=" + storageUtil_1.getUserIDFromStorage() + "&currentTermID=" + this.state.currentTerm);
	    };
	    ComprehensiveQualityRecord.prototype.goToAssessTestReport = function () {
	        window.open(commonVar_1.comprehensiveURL + "/assessTestReport.html?queryUserID=" + storageUtil_1.getUserIDFromStorage() + "&currentTermID=" + this.state.currentTerm);
	    };
	    ComprehensiveQualityRecord.prototype.render = function () {
	        return (React.createElement("div", null, React.createElement(PersonInfoAndRank, {roleEnum: 0 /* student */, currentTerm: this.state.currentTerm, onTermChange: this.onTermChange}), React.createElement("div", {className: "am-margin-top block-box-shadows blueBack"}, React.createElement("div", {className: "text-colorLine am-text-center"}, "我的综合素质档案"), React.createElement(antd_1.Row, {style: { margin: "30px 20px" }}, React.createElement(antd_1.Col, {span: 8, className: "comprehensive-box-single", onClick: this.goToComprehensiveQualityReport}, React.createElement("img", {src: "vendor/images/termComp.png"}), React.createElement("div", {className: "text-btn blueLight"}, "学期综合素质档案")), React.createElement(antd_1.Col, {span: 8, className: "comprehensive-box-single "}, React.createElement("img", {src: "vendor/images/termComp.png"}), React.createElement("div", {className: "text-btn blueNormal"}, "学生综合素养情况记录表")), React.createElement(antd_1.Col, {span: 8, className: "comprehensive-box-single ", onClick: this.goToAssessTestReport}, React.createElement("img", {src: "vendor/images/assessComp.png"}), React.createElement("div", {className: "text-btn blueGrey"}, "生涯测试结果报告"))))));
	    };
	    return ComprehensiveQualityRecord;
	}(React.Component));
	module.exports = ComprehensiveQualityRecord;
