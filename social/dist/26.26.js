...
/***/ 698:
/*!*************************************************************!*\
  !*** ./pages/AdminPage/HonorManagement/HonorManagement.tsx ***!
  \*************************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var ActionTypes = __webpack_require__(/*! ../../../actions/AdminPage/AdminPageActionTypes */ 382);
	"use strict";
	var HonorManagement = (function (_super) {
	    __extends(HonorManagement, _super);
	    function HonorManagement(props) {
	        _super.call(this, props);
	        this.state = {};
	    }
	    HonorManagement.prototype.render = function () {
	        /*var subTab = [
	    ...
	    HonorManagement.defaultProps = {};
	    return HonorManagement;
	}(React.Component));
	module.exports = HonorManagement;
