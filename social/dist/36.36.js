...
/***/ 739:
/*!********************************************************!*\
  !*** ./pages/TermAnalysis/RankInClass/RankInClass.tsx ***!
  \********************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var RankInClassChart = __webpack_require__(/*! ./Component/RankInClassChart */ 522);
	"use strict";
	var RankInClass = (function (_super) {
	    ...
	    RankInClass.prototype.render = function () {
	        return (React.createElement("div", null, React.createElement(PersonInfoAndRank, {roleEnum: 0 /* student */, selectShow: false}), React.createElement("div", {className: "block-box-shadows-0 blueBack am-margin-top"}, React.createElement(CardWithTitleBox, {title: "班级积分排名图", subComponent: React.createElement(RankInClassChart, null)}))));
	    };
	    return RankInClass;
	}(React.Component));
