...
/***/ 772:
/*!************************************************************************!*\
  !*** ./pages/TermAnalysis/AcademicPerformance/AcademicPerformance.tsx ***!
  \************************************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var ScoresWithTerm = __webpack_require__(/*! ./Component/ScoresWithTerm */ 773);
	"use strict";
	var AcademicPerformance = (function (_super) {
	    __extends(AcademicPerformance, _super);
	    function AcademicPerformance(props) {
	        _super.call(this, props);
	    }
	    AcademicPerformance.prototype.render = function () {
	        return (React.createElement("div", null, React.createElement(PersonInfoAndRank, null), React.createElement("div", {className: "block-box-shadows-0 blueBack am-margin-top"}, React.createElement(CardWithTitleBox, {title: "考试成绩", subComponent: React.createElement(ScoresWithTerm, null)}))));
	    };
	    AcademicPerformance.defaultProps = {};
