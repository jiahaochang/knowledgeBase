...
/***/ 766:
/*!************************************************************!*\
  !*** ./pages/TermAnalysis/TeacherReview/TeacherReview.tsx ***!
  \************************************************************/
/***/ function(module, exports, __webpack_require__) {
	...
	var antd_1 = __webpack_require__(/*! antd */ 386);
	var storageUtil_1 = __webpack_require__(/*! common/storageUtil */ 383);
	var TeacherReview = (function (_super) {
	    __extends(TeacherReview, _super);
	    ...
	    TeacherReview.prototype.onTermChange = function (termAfterChange) {
	        this.setStateByTermID(termAfterChange);
	        this.setState({
	            currentTerm: termAfterChange
	        });
	    };
	    TeacherReview.prototype.setStateByTermID = function (currentTerm) {
	        var this_ = this;
	        var queryObj = {
	            termID: currentTerm,
	            studentUserID: storageUtil_1.getUserIDFromStorage()
	        };
	        ajaxUtil_1.getDataByActionIDWithQuery(actionTypes.GET_STUDENT_TEACHEREVALUATE, queryObj, function (response) {
	    ...
	    TeacherReview.prototype.componentWillMount = function () {
	        var this_ = this;
	        this.setStateByTermID(this.state.currentTerm);
	    };
	    TeacherReview.prototype.render = function () {
	        var teacherTermEvaluation = this.state.reviewData.teacherTermEvaluation;
	        var evaluationContent = commonFunc_1.isEmptyObject(teacherTermEvaluation.evaluationContent) ? "班主任尚未填写…" : teacherTermEvaluation.evaluationContent;
	        return (React.createElement("div", null, React.createElement(PersonInfoAndRank, {roleEnum: 0 /* student */, onTermChange: this.onTermChange, currentTerm: this.state.currentTerm}), React.createElement("div", {className: "block-box-shadows am-margin-top"}, React.createElement("div", {className: "textarea-with-title"}, React.createElement("div", {className: "title am-padding-left-sm"}, "班主任老师评语"), React.createElement("div", {className: "teacher-comments-box"}, React.createElement("div", {className: "sub-div"}, evaluationContent))), !teacherTermEvaluation.qualityEvaluationFinished &&
	            React.createElement(antd_1.Alert, {message: "班主任还没来得及打分哦……", type: "warning", showIcon: true}), React.createElement(antd_1.Row, null, React.createElement(antd_1.Col, {span: 7, className: "am-text-center "}, React.createElement("b", {style: { color: "#10579e" }}, "班主任打分：")), React.createElement(antd_1.Col, {span: 17}, React.createElement(antd_1.Row, null, teacherTermEvaluation.qualityEvaluations.map(function (item, index) { return (React.createElement(antd_1.Col, {key: index, span: 12}, React.createElement("b", {className: "am-padding-right-xs"}, item.qualityCategoryName), React.createElement(antd_1.Rate, {value: Number(item.evaluationScore), allowHalf: true, disabled: true}))); })))))));
	    };
	    TeacherReview.defaultProps = {};
